...
<div class="mx-auto mt-[14px] mb-[28px] max-w-3xl flex flex-col items-center">
  <div style="width: calc(100% - 28px);" class="bg-primary-dark h-[14px]"></div>
  <footer class="px-7 py-4 bg-primary-dark w-full relative before:absolute before:-bottom-[14px] before:left-0 before:h-[14px] before:w-full before:bg-secondary">
